...
from rocketpy.motors import SolidMotor, HybridMotor

from .stochastic_motor_model import StochasticMotorModel

class StochasticHybridMotor(StochasticMotorModel):
    """A Stochastic Hybrid Motor class that inherits from StochasticModel.
    ...
    def __init__(
        ...
        super().__init__(
            hybrid_motor,
            positioned_tanks=positioned_tanks,
    ...
    def create_object(self):
        """Creates and returns a HybridMotor object from the randomly generated
        input arguments.
        ...
        for tank, position in self.positioned_tanks:
